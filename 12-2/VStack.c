...
Boolean VStack_push (VStack* _this, VElement anElement) { //Stack push
...
VElement VStack_pop (VStack* _this) {  //Stack pop
	VElement poppedElement;
...
VElement VStack_topElement (VStack* _this) { //Stack peek
	return VNode_element (_this->_top);
}

VElement VStack_elementAt (VStack* _this, int anOrder) { // elementAt 구현
