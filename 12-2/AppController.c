...
void AppController_run (AppController* _this) {
	...
	_this->_postfix=Postfix_new (MAX_NUMBER_OF_TOKENS); //후위식 생성 //todo infix 로 변경
	expressionIsAvailable=AppView_in_postfixExpression (_this->_expression); //후위식 셋팅 //todo infix 로 변경
