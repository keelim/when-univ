public class AppController {
    ...
    public AppController() {
        this.setQueue(new  CircularlyLinkedQueue<Character>(AppController.QUEUE_CAPACITY)); // todo
...
// 횟수 계산
    ...
    // 큐 수행 관련
    private void addToQueue(char aCharForAdd) { //todo
//큐가 가득 찬 경우
