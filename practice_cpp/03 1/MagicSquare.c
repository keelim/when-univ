...
Boolean MagicSquare_ordersVaild(int anOrder) { //전달 값으로 받는 차수의 유효성 확인
	if (anOrder < 3) {
...
void MagicSquare_solve(int anOrder, int aBoard[MAX_ORDER][MAX_ORDER]) { //입력 받은 것을 푼다. 
	int row, col;
