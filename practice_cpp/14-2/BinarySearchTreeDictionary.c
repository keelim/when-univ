...
void BinarySearchTreeDictionary_deleteBinaryNodes(BinarySearchTreeDictionary *_this, BinaryNode *aNode);

Boolean Dictionary_addToTree(BinarySearchTreeDictionary *_this, Key *aKey, Object *anObject, BinaryNode *parent);

Object *
BinarySearchTreeDictionary_searchTreeRecursively(BinarySearchTreeDictionary *_this, Key *aKey, BinaryNode *aNode);

Object *BinarySearchTreeDictionary_removeFromTreeRecursively(BinarySearchTreeDictionary *_this, Key *aKey,
                                                             BinaryNode *parent);

Object *BinarySearchTreeDictionary_removeRightmostNodeOfLeftSubtree(BinarySearchTreeDictionary *_this,
                                                                    BinaryNode *rootOfLeftSubtree);
...
void BinarySearchTreeDictionary_delete(BinarySearchTreeDictionary *_this) {
    BinarySearchTreeDictionary_deleteBinaryNodes(_this, _this->_root);
    free(_this);
}
...
Boolean BinarySearchTreeDictionary_keyDoesExist(BinarySearchTreeDictionary *_this, Key *aKey) {
    return BinarySearchTreeDictionary_searchTreeRecursively(_this, aKey, _this->_root) != NULL;
}
...
Element *BinarySearchTreeDictionary_removeObjectForKey(BinarySearchTreeDictionary *_this, Key *aKey) {
    if (BinarySearchTreeDictionary_isEmpty(_this)) {
        ...
        if (Key_compareTo(aKey, BinaryNode_key(_this->_root)) != 0) {
            return (BinarySearchTreeDictionary_removeFromTreeRecursively(_this, aKey, _this->_root));
        } else {
...
void BinarySearchTreeDictionary_deleteBinaryNodes(BinarySearchTreeDictionary *_this, BinaryNode *aNode) {
    if (aNode != NULL) {
        BinarySearchTreeDictionary_deleteBinaryNodes(_this, BinaryNode_left(aNode));
        BinarySearchTreeDictionary_deleteBinaryNodes(_this, BinaryNode_right(aNode));
