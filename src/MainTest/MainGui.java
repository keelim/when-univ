...
public class MainGui extends JFrame {
    ...
    public MainGui() {
        ...
        JOptionPane.showMessageDialog(null, "서버에서 아이디를 확인 합니다. "); //핸들러를 통하여 데이터를 받아야 한다.
        JOptionPane.showMessageDialog(null, "서버에 접속하였습니다. "); //핸들러를 통하여 데이터를 받아야 한다.
        if(client.resultComm.getStatus() != 1){
            JOptionPane.showMessageDialog(null, "접속 되어 있는 아이디 입니다. 접속할 수 없습니다. 프로그램을 종료 합니다. ");
            client.close();
