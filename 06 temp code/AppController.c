...
void AppController_showStatics(AppController* _this) //통계 함수를 출력을 한다. 
{
	AppView_out_averageScore(Ban_averageScore(_this->ban)); //평균 이상 점수
	AppView_out_numberOfStudentsAboveAverage(Ban_numberOfStudentsAboveAverage(_this->ban)); //평균 이상 몇명?
